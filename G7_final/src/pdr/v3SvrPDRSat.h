...
class V3SvrPDRSat
{
   ...
   public : 
      ...
      void ternarySimInit(Cube* c, vector<bool>& ii);
      void ternarySimulation(Cube* preImg, Cube* img, bool b, vector<bool>& input);

      void newActVar();
      void initValue3Data();
      void dfs(V3NetVec& orderedNets, bool isMonitor, vector<bool>& isNxt);
      void dfs_jump(V3NetVec& orderedNets, vector<bool>& isNxt, Cube* c);
      ...
      Cube* UNSATGeneralizationWithUNSATCore(Cube* c, vector<Lit>& Lit_vec_origin, bool newCube);
      void generalizeProof(Cube* c);
   ...
   // private :
      ...
      V3Vec<Value3>::Vec        _Value3List;// Mapping between V3NetId and Value3, used for simulationz
      V3NetVec                  _monitorNets;
      vector<bool>              _isNextS;    //
      V3NetVec                  _allNets;    //
};
